      ...
      let data =  Mock.mock({
            "data": {
                ["list|30"]: [{
                    ...
                    "clickNum": ()=>Random.integer(100,100000),//点击量
                    "clickRate": ()=>Random.integer(100,100000),//点击率
                    "clickPrice": ()=>Random.integer(100,100000),//点击均价；  单位是分 消费/点击量
                    "cpmPrice": ()=>Random.integer(100,100000),//千次展示均价；  单位是分 消费/曝光量
